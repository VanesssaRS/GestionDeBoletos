...
public class JComprarBoleto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnSeleccionarAsientos, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 156, 33));
        ...
        jPanel2.add(lblCheckAsientos, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 160, -1, -1));
        ...
        jLabel10.setText("Comprar Boleto");
    ...
    private void btnSeleccionarAsientosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarAsientosActionPerformed
        ...
        if ((int) jSpinner1.getValue() > 0 && viajeSelected.getBus() != null) {
            new FrmAsientos(viajeSelected.getBus(), (int) jSpinner1.getValue()).setVisible(true);
            return;
        }
