...
import Visual.Administrador.FrmDashBoard;
import Visual.Pasajero.FrmPDashBoard;
import Visual.Vendedor.FrmVDashBoard;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Visual/images/logo.png"))); // NOI18N
        ...
        citybg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Visual/images/city.png"))); // NOI18N
        ...
        favicon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Visual/images/favicon.png"))); // NOI18N
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        ...
        if(Validaciones.validarStrings(user,password)){
            if(LoginManager.getinstance().login(user,password)){
                Persona loged = LoginManager.getLoggedPerson();
                if(loged != null){
                    switch (loged.getTipoUsuario()){
                        case PASAJERO:{
                            java.awt.EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    new FrmPDashBoard(loged).setVisible(true);
                                }
                            });
                            dispose();
                            break;
                        ...
                        case ADMINISTRADOR:{
                            java.awt.EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    new FrmDashBoard(loged).setVisible(true);
                                }
                            });
                            dispose();
                            break;
                        ...
                        case VENDERDOR:{
                            java.awt.EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    new FrmVDashBoard(loged).setVisible(true);
                                }
                            });
                            dispose();
                            break;
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "¡Usuario/Contraseña incorrecta!");
            return;
        }
        javax.swing.JOptionPane.showMessageDialog(null, "¡Complete los campos!");
